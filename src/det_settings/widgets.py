...
select_det_settings_button = ElementButton(text='SELECT SETTINGS', button_type='primary')
...
det_settings_selected_done_label = DoneLabel(text='Detection settings selected')
